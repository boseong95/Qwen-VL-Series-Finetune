"""Convert HuggingFaceM4/the_cauldron counting subsets to LLaVA JSONL format.

Output: /NHNHOME/WORKSPACE/0426030085_A/dataset/counting/qwen/
...
COUNTING_SUBSETS = ["tallyqa", "clevr", "clevr_math", "cocoqa", "dvqa", "figureqa"]

SRC  = "/NHNHOME/WORKSPACE/0426030085_A/dataset/the_cauldron"
DST  = "/NHNHOME/WORKSPACE/0426030085_A/dataset/counting/qwen"
VAL_RATIO = 0.10
SEED = 42
...
def main():
    ...
    all_records = []
    for subset in COUNTING_SUBSETS:
