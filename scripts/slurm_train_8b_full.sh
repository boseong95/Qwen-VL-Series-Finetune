#!/bin/bash
#SBATCH --job-name=qwen3vl-8b-full
...
#SBATCH --output=output/surgical_vqa_qwen3vl_8b_full/slurm_%j.out
#SBATCH --error=output/surgical_vqa_qwen3vl_8b_full/slurm_%j.err
...
OUTPUT_DIR="output/surgical_vqa_qwen3vl_8b_full"
