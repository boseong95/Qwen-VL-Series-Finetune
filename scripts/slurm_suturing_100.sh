...
#SBATCH --output=output/suturing_100/slurm_%j.out
#SBATCH --error=output/suturing_100/slurm_%j.err
...
OUTPUT_DIR="output/suturing_100"
...
# ── Data: 100% suturing VQA (geometry in [0,1] normalized coords) ─────────────
#
# Adjust SUTURING_BASE and image_folder if your layout differs.
# Expected layout:
#   $SUTURING_BASE/vqa_dataset/train.json
#   $SUTURING_BASE/vqa_dataset/val.json
#   images referenced in JSONs (absolute paths or relative to $SUTURING_BASE)
#
SUTURING_BASE="/NHNHOME/WORKSPACE/0426030085_A/dataset/suturing"
DATA_PATH="${SUTURING_BASE}/vqa_dataset/train.json"
EVAL_PATH="${SUTURING_BASE}/vqa_dataset/val.json"
