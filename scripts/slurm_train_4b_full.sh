#!/bin/bash
#SBATCH --job-name=qwen3vl-4b-full
...
#SBATCH --output=output/surgical_vqa_qwen3vl_4b_full/slurm_%j.out
#SBATCH --error=output/surgical_vqa_qwen3vl_4b_full/slurm_%j.err
...
# ── Config ────────────────────────────────────────────────────────────────────
MODEL_NAME="/NHNHOME/WORKSPACE/0426030085_A/boseong/models/Qwen3-VL-4B-Instruct"
OUTPUT_DIR="output/surgical_vqa_qwen3vl_4b_full"
