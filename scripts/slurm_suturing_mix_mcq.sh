#!/bin/bash
#SBATCH --job-name=suturing-mix-mcq
...
#SBATCH --output=output/suturing_mix_mcq/slurm_%j.out
#SBATCH --error=output/suturing_mix_mcq/slurm_%j.err
...
OUTPUT_DIR="output/suturing_mix_mcq"
...
# ── Data mixture: 50% Suturing / 50% Generic surgical MCQ ─────────────────────
#
#   Dataset     | Available  | Ratio
#   ------------|------------|-------
#   Suturing    | ~N         | 100%
#   MCQ         |  98,204    |  61%  (~60k samples)
#
