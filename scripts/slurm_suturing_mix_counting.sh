#!/bin/bash
#SBATCH --job-name=suturing-mix-cnt
...
#SBATCH --output=output/suturing_mix_counting/slurm_%j.out
#SBATCH --error=output/suturing_mix_counting/slurm_%j.err
...
OUTPUT_DIR="output/suturing_mix_counting"
...
# ── Data mixture: 50% Suturing / 50% Counting ─────────────────────────────────
#
#   Dataset     | Available  | Ratio
#   ------------|------------|-------
#   Suturing    | ~N         | 100%
#   Counting    | 526,470    |  11%  (~60k samples)
#
